$(document).ready(function(){
   ...
   $("#shopping_commend_sort").toggle();
	...
	//商品隔行变色
	$("#myTableProduct").find("tr:odd").css("background-color","#D7EFF8");
	//商品变色
	$("#myTableProduct").find("tr").mouseout(function(){
		$(this).css("background-color","#FFFFFF");
	}).mouseout(function(){
		if ($("#myTableProduct").find("tr").index($(this))%2==1) {//是否为奇数行
			$(this).css("background-color","#D7EFF8");
		}else{
