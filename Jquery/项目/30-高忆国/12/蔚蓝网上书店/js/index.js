$(function($){
   ...
   window.open('open.html','','top=0,left=200,width=500,height=327,scrollbars=0,resizable=0');
	...
	function changeImg(){
		...
		//图书畅销切换
		$("。tap ol li:first-of-type").mouseover(function(){
			$(".tap ol li:last-of-type").css({"background":"#efefef","border-left":"1px solid #cccccc","border-bottom":"1px solid #ccc","width":"118px"});
			$(this).css({"Width":"119px","background":"#ffffff","border":"none"});
			$(".tap ul:first-of-type").show();
			$(".tap ul:last-of-type").hide();
		});
		$(".tap ol li:last-of-type").mouseover(function(){
			$(".tap ol li:first-of-type").css({"background":"#efefef","border-right":"1px solid #cccccc","border-bottom":"1px solid #ccc","width":"118px"});
			$(this).css({"width":"119px","background":"#ffffff","border":"none"});
			$(".tap ul:first-of-type").hide();
			$(".tap ul:last-of-type").show();
